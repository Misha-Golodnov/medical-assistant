...
Медицинский ассистент - сервис поддержки принятия врачебных решений на базе RAG (Retrieval-Augmented Generation) для работы с клиническими рекомендациями Минздрава РФ.

## 📋 О проекте

Medical Assistant предоставляет структурированную информацию из клинических рекомендаций Минздрава РФ на основе предполагаемого диагноза.

Врач указывает код диагноза по МКБ-10 (через Telegram бот или API), а система возвращает:
- 🩺 Характерные симптомы заболевания
- 🔬 Рекомендуемые обследования и анализы
- 💊 Лекарственные назначения с конкретными дозировками
- 📋 Дополнительные рекомендации по лечению

## 🎯 Возможности

### Версия 2.0 (текущая)
- 📚 **База знаний**: 60 клинических рекомендаций (коды МКБ-10: I*, G*), 62,879 семантических чанков
- 🔍 **Векторный поиск**: PostgreSQL + pgvector, cosine similarity
- 🤖 **Генерация ответов**: GPT-4o с расширенным контекстом (50 chunks, 32K tokens)
- 💬 **Telegram бот**: медицинская фильтрация, HTML-форматирование, команды `/start`, `/help`, `/find`
- 📊 **Аналитика**: логирование запросов в PostgreSQL с метриками стоимости
- 🔎 **Умный поиск по МКБ-10**: prefix matching (I21 → I21.0, I21.1, ...)

### Архитектура
- **RAG Pipeline**: Точный поиск + контекстная генерация ответов
- **Векторный поиск**: Semantic search по 62,879 медицинским фрагментам
